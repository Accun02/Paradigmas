...
namespace MyGame
{
    public class CharacterController
    {
        ...
        public void ShootHorizontal()
        {
            if (isLookingRight)
            {
                GameManager.Instance.LevelController.BulletList.Add(new Bullet((int)transform.Position.x + ((int)Character.PlayerWidth / 2) + 10 / 2,
                (int)transform.Position.y + (int)Character.PlayerHeight / 2, new Vector2(1, 0), "assets/bullet/bulletX.png", true));
            }
            else if (isLookingLeft)
            {
                GameManager.Instance.LevelController.BulletList.Add(new Bullet((int)transform.Position.x + ((int)Character.PlayerWidth / 2) - 60,
                (int)transform.Position.y + (int)Character.PlayerHeight / 2, new Vector2(-1, 0), "assets/bullet/bulletX.png", true));
            }
        }
    }
